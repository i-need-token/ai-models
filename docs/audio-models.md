...
[中文](zh/audio-models.md)

AI models that support audio input or output, sourced from the [AI Models Catalog](https://github.com/i-need-token/ai-models).

## Stats

| Metric             | Count |
| ------------------ | ----- |
| Total audio models | 136   |
| Audio input        | 118   |
| Audio output       | 34    |
| Free               | 0     |
| Open weights       | 7     |
...
`aihubmix`, `amazon`, `amazon-bedrock`, `cortecs`, `digitalocean`, `fastrouter`, `google`, `google-vertex`, `groq`, `hpc-ai`, `microsoft`, `minimax`, `mistral`, `novitaai`, `openai`, `openrouter`, `scaleway`, `stepfun`, `vultr`, `xiaomi`
...
| gpt-4o-audio-preview                                 | aihubmix       | —       | $1.25       | 🎤 in              |
| gpt-4o-mini-audio-preview                            | aihubmix       | —       | $0.075      | 🎤 in              |
...
| mistral-voxtral-mini                                 | amazon-bedrock | —       | $0.04       | 🎤 in              |
| mistral-voxtral-small                                | amazon-bedrock | —       | $0.1        | 🎤 in              |
| gemini-2.0-flash-001                                 | cortecs        | —       | $0.134      | 🎤 in 🔧           |
| gemini-2.0-flash-lite-001                            | cortecs        | —       | $0.067      | 🎤 in 🔧           |
| gemini-2.5-flash                                     | cortecs        | —       | $0.268      | 🎤 in 🔧 🧠        |
| gemini-2.5-pro                                       | cortecs        | —       | $1.342      | 🎤 in 🔧 🧠        |
| gemini-3.1-flash-lite                                | cortecs        | —       | $0.244      | 🎤 in 🔧 🧠        |
| voxtral-small-2507                                   | cortecs        | —       | $0.1        | 🎤 in              |
| nemotron-3-nano-omni                                 | digitalocean   | —       | $0.5        | 🎤 in 🔓           |
| google--gemini-3.1-flash-lite-preview                | fastrouter     | —       | $0.25       | 🎤 in 🔧 🧠        |
| google--gemini-3.1-pro-preview                       | fastrouter     | —       | $2          | 🎤 in 🔧 🧠        |
| openai--gpt-4o-realtime-preview-2024-12-17           | fastrouter     | —       | $5          | 🎤 in 🔊 out       |
| openai--gpt-4o-realtime-preview-2025-06-03           | fastrouter     | —       | $5          | 🎤 in 🔊 out       |
| openai--gpt-realtime                                 | fastrouter     | —       | $4          | 🎤 in 🔊 out       |
| openai--gpt-realtime-1.5                             | fastrouter     | —       | $4          | 🎤 in 🔊 out       |
| openai--gpt-realtime-mini                            | fastrouter     | —       | $0.6        | 🎤 in 🔊 out       |
| chirp-3.0-HD                                         | google         | —       | —           | 🎤 in              |
...
| lyria-2.0                                            | google         | —       | —           | 🔊 out             |
| gemini-2-0-flash                                     | google-vertex  | —       | $0.15       | 🎤 in 🔧           |
| gemini-2-0-flash-lite                                | google-vertex  | —       | $0.075      | 🎤 in 🔧           |
| gemini-2-5-pro                                       | google-vertex  | —       | $1.25       | 🎤 in 🔧           |
| gemini-3-pro                                         | google-vertex  | —       | $2          | 🎤 in 🔧           |
| orpheus-ar-sa                                        | groq           | —       | —           | 🔊 out             |
| orpheus-en                                           | groq           | —       | —           | 🔊 out             |
| whisper-large-v3                                     | groq           | —       | —           | 🎤 in              |
| whisper-large-v3-turbo                               | groq           | —       | —           | 🎤 in              |
| xiaomi--mimo-v2.5                                    | hpc-ai         | —       | $0.4        | 🎤 in 🔧 🧠 🔓     |
| microsoft-phi-4-mini-multimodal                      | microsoft      | —       | $0.08       | 🎤 in 🔧           |
| music-2.6                                            | minimax        | —       | —           | 🔊 out             |
| music-cover                                          | minimax        | —       | —           | 🔊 out             |
| speech-02-hd                                         | minimax        | —       | —           | 🔊 out             |
| speech-02-turbo                                      | minimax        | —       | —           | 🔊 out             |
| speech-2.6-hd                                        | minimax        | —       | —           | 🔊 out             |
| speech-2.6-turbo                                     | minimax        | —       | —           | 🔊 out             |
| speech-2.8-hd                                        | minimax        | —       | —           | 🔊 out             |
| speech-2.8-turbo                                     | minimax        | —       | —           | 🔊 out             |
| voxtral-mini                                         | mistral        | —       | $0.04       | 🎤 in              |
| voxtral-small                                        | mistral        | —       | $0.1        | 🎤 in              |
| qwen--qwen3-omni-30b-a3b-instruct                    | novitaai       | —       | —           | 🎤 in 🔊 out 🔧    |
| qwen--qwen3-omni-30b-a3b-thinking                    | novitaai       | —       | —           | 🎤 in 🔧 🧠        |
| gpt-4o-audio                                         | openai         | —       | $2.5        | 🎤 in 🔊 out 🔧    |
| gpt-4o-realtime                                      | openai         | —       | $5          | 🎤 in 🔊 out 🔧    |
| o1-realtime                                          | openai         | —       | $15         | 🎤 in 🔊 out 🔧 🧠 |
| tts-1                                                | openai         | —       | —           | 🔊 out             |
| tts-1-hd                                             | openai         | —       | —           | 🔊 out             |
| whisper-1                                            | openai         | —       | —           | 🎤 in              |
...
| google--gemini-2.5-pro-preview                       | openrouter     | —       | $1.25       | 🎤 in 🔧 🧠        |
...
| google--lyria-3-clip-preview                         | openrouter     | —       | —           | 🔊 out             |
| google--lyria-3-pro-preview                          | openrouter     | —       | —           | 🔊 out             |
| mistralai--voxtral-small-24b-2507                    | openrouter     | —       | $0.1        | 🎤 in 🔧           |
| nvidia--nemotron-3-nano-omni-30b-a3b-reasoning--free | openrouter     | —       | —           | 🎤 in 🔧 🧠        |
| openai--gpt-4o-audio-preview                         | openrouter     | —       | $2.5        | 🎤 in 🔊 out 🔧    |
| openai--gpt-audio                                    | openrouter     | —       | $2.5        | 🎤 in 🔊 out 🔧    |
| openai--gpt-audio-mini                               | openrouter     | —       | $0.6        | 🎤 in 🔊 out 🔧    |
...
| voxtral-small-24b-2507                               | scaleway       | —       | $0.15       | 🎤 in 🔓           |
| step-1o-audio                                        | stepfun        | —       | $25         | 🎤 in 🔊 out       |
| step-asr                                             | stepfun        | —       | —           | 🎤 in              |
| step-asr-1.1                                         | stepfun        | —       | —           | 🎤 in              |
| step-asr-1.1-stream                                  | stepfun        | —       | —           | 🎤 in              |
| step-audio-2                                         | stepfun        | —       | $10         | 🎤 in 🔊 out       |
| step-audio-r1.1                                      | stepfun        | —       | —           | 🎤 in 🔊 out       |
| step-tts-2                                           | stepfun        | —       | —           | 🔊 out             |
| step-tts-mini                                        | stepfun        | —       | —           | 🔊 out             |
| stepaudio-2-asr-pro                                  | stepfun        | —       | —           | 🎤 in              |
| stepaudio-2.5-asr                                    | stepfun        | —       | —           | 🎤 in              |
| stepaudio-2.5-chat                                   | stepfun        | —       | $10         | 🎤 in              |
| stepaudio-2.5-realtime                               | stepfun        | —       | $10         | 🎤 in 🔊 out       |
| stepaudio-2.5-tts                                    | stepfun        | —       | —           | 🔊 out             |
