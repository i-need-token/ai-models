...
// ---------------------------------------------------------------------------
// Raw data types (from Perplexity API)
// ---------------------------------------------------------------------------
...
async function fetchModels(): Promise<PerplexityModel[]> {
  ...
  const data = (await response.json()) as { data: PerplexityModel[] };
  return data.data;
}
...
const pipeline: ScrapePipeline = {
  discover: {
    source: {
      ...
      type: "api",
      description: "Perplexity /v1/models API — dynamic model discovery",
    },
  ...
  extractPricing: {
    source: {
      url: "https://api.perplexity.ai/models",
      type: "api",
      description: "Perplexity API — pricing not available via API, omitted",
    },
  ...
  extractLimits: {
    source: {
      url: "https://api.perplexity.ai/models",
      type: "api",
      description: "Perplexity API — limits not available via API, omitted",
    },
  ...
  extractModalities: {
    source: {
      url: "https://api.perplexity.ai/models",
      type: "api",
      description: "Perplexity API — modalities not available via API, omitted",
    },
  ...
  extractFeatures: {
    source: {
      url: "https://api.perplexity.ai/models",
      type: "api",
      description: "Perplexity API — features not available via API, omitted",
    },
  ...
  extractDates: {
    source: {
      url: "https://api.perplexity.ai/models",
      type: "api",
      description: "Perplexity API — created timestamp for dates",
    },
    execute: async (models: DiscoveredModel[]): Promise<Map<string, ExtractedDates>> => {
      const datesMap = new Map<string, ExtractedDates>();

      for (const m of models) {
        const raw = m.raw as PerplexityModel;
