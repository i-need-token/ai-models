...
// ---------------------------------------------------------------------------
// Raw data types (from Clarifai API)
// ---------------------------------------------------------------------------
...
async function fetchModels(): Promise<ClarifaiModel[]> {
  const response = await fetch("https://api.clarifai.com/v1/models");
  if (!response.ok) {
    throw new Error(`Failed to fetch Clarifai models: ${response.status}`);
  }
  const data = (await response.json()) as { data: ClarifaiModel[] };
  return data.data;
}
...
const pipeline: ScrapePipeline = {
  discover: {
    source: {
      url: "https://api.clarifai.com/v1/models",
      type: "api",
      description: "Clarifai /v1/models API — dynamic model discovery",
    },
  ...
  extractPricing: {
    source: {
      url: "https://api.clarifai.com/v1/models",
      type: "api",
      description: "Clarifai API — pricing not available via API, omitted",
    },
  ...
  extractLimits: {
    source: {
      url: "https://api.clarifai.com/v1/models",
      type: "api",
      description: "Clarifai API — limits not available via API, omitted",
    },
  ...
  extractModalities: {
    source: {
      url: "https://api.clarifai.com/v1/models",
      type: "api",
      description: "Clarifai API — modalities not available via API, omitted",
    },
  ...
  extractFeatures: {
    source: {
      url: "https://api.clarifai.com/v1/models",
      type: "api",
      description: "Clarifai API — features not available via API, omitted",
    },
  ...
  extractDates: {
    source: {
      url: "https://api.clarifai.com/v1/models",
      type: "api",
      description: "Clarifai API — created timestamp for dates",
    },
    execute: async (models: DiscoveredModel[]): Promise<Map<string, ExtractedDates>> => {
      const datesMap = new Map<string, ExtractedDates>();

      for (const m of models) {
        const raw = m.raw as ClarifaiModel;
