...
// ---------------------------------------------------------------------------
// Raw data types (from MiniMax API)
// ---------------------------------------------------------------------------
...
async function fetchModels(): Promise<MinimaxModel[]> {
  ...
  const data = (await response.json()) as { data: MinimaxModel[] };
  return data.data;
}
...
const pipeline: ScrapePipeline = {
  discover: {
    source: {
      ...
      type: "api",
      description: "MiniMax /v1/models API — dynamic model discovery",
    },
  ...
  extractPricing: {
    source: {
      url: "https://api.minimaxi.com/v1/models",
      type: "api",
      description: "MiniMax API — pricing not available via API, omitted",
    },
  ...
  extractLimits: {
    source: {
      url: "https://api.minimaxi.com/v1/models",
      type: "api",
      description: "MiniMax API — limits not available via API, omitted",
    },
  ...
  extractModalities: {
    source: {
      url: "https://api.minimaxi.com/v1/models",
      type: "api",
      description: "MiniMax API — modalities not available via API, omitted",
    },
  ...
  extractFeatures: {
    source: {
      url: "https://api.minimaxi.com/v1/models",
      type: "api",
      description: "MiniMax API — features not available via API, omitted",
    },
  ...
  extractDates: {
    source: {
      url: "https://api.minimaxi.com/v1/models",
      type: "api",
      description: "MiniMax API — created timestamp for dates",
    },
    execute: async (models: DiscoveredModel[]): Promise<Map<string, ExtractedDates>> => {
      const datesMap = new Map<string, ExtractedDates>();

      for (const m of models) {
        const raw = m.raw as MinimaxModel;
