...
const pipeline: ScrapePipeline = {
  discover: {
    source: {
      ...
      type: "api",
      description: "Groq /v1/models API — dynamic model discovery",
    },
  ...
  extractPricing: {
    source: {
      url: "https://api.groq.com/openai/v1/models",
      type: "api",
      description: "Groq API — pricing not available via API, omitted",
    },
  ...
  extractLimits: {
    source: {
      url: "https://api.groq.com/openai/v1/models",
      type: "api",
      description: "Groq API — limits not available via API, omitted",
    },
  ...
  extractModalities: {
    source: {
      url: "https://api.groq.com/openai/v1/models",
      type: "api",
      description: "Groq API — modalities not available via API, omitted",
    },
  ...
  extractFeatures: {
    source: {
      url: "https://api.groq.com/openai/v1/models",
      type: "api",
      description: "Groq API — features not available via API, omitted",
    },
  ...
  extractDates: {
    source: {
      url: "https://api.groq.com/openai/v1/models",
      type: "api",
      description: "Groq API — created timestamp for dates",
    },
    execute: async (models: DiscoveredModel[]): Promise<Map<string, ExtractedDates>> => {
      const datesMap = new Map<string, ExtractedDates>();

      for (const m of models) {
        const raw = m.raw as GroqModel;
